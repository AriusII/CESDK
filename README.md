...
[![Build](https://img.shields.io/github/actions/workflow/status/ShadowNineX/CESDK/build.yml?branch=main&style=flat-square&logo=githubactions&logoColor=white&labelColor=24292f)](https://github.com/ShadowNineX/CESDK/actions/workflows/build.yml)
...
Warnings are errors, so the build is also the lint step. Tests tagged `Category=NativeLua` need a Lua 5.3 DLL and report
Skipped without one; [`tests/CESDK.Tests.Shared`](tests/CESDK.Tests.Shared/README.md) explains how the DLL is found.
...
No Cheat Engine file is redistributed here.
